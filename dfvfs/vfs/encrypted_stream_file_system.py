...
class EncryptedStreamFileSystem(root_only_file_system.RootOnlyFileSystem):
  """Class that implements a encrypted stream file system object."""
  ...
  def GetRootFileEntry(self):
    ...
    path_spec = encrypted_stream_path_spec.EncryptedStreamPathSpec(
        ...
        key=self._path_spec.key,
        block_cipher_mode=self._path_spec.block_cipher_mode,
        iv=self._path_spec.iv,
        segment_size=self._path_spec.segment_size,
