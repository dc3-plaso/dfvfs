...
# The block cipher mode of operation definitions.
BLOCK_CIPHER_MODE_CBC = u'CBC'
BLOCK_CIPHER_MODE_CFB = u'CFB'
BLOCK_CIPHER_MODE_ECB = u'ECB'
BLOCK_CIPHER_MODE_OFB = u'OFB'
BLOCK_CIPHER_MODE_PCBC = u'PCBC'
