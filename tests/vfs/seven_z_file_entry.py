...
from dfvfs.vfs import seven_z_file_entry
from dfvfs.vfs import seven_z_file_system


class SevenZFileEntryTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self._file_system = seven_z_file_system.SevenZFileSystem(
        self._resolver_context)
    self._file_system.Open(path_spec=self._seven_z_path_spec)
  ...
  def testIntialize(self):
    ...
    file_entry = seven_z_file_entry.SevenZFileEntry(
        self._resolver_context, self._file_system, self._seven_z_path_spec)
